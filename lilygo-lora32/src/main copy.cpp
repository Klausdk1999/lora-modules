 ...
 * - Transmission interval: 1 minute (60 seconds) - configurable for production
 * 
...
#define TX_INTERVAL_SECONDS     60      // Send data every 1 minute (60 seconds) - can be increased later for production
